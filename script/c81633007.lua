...
local ARCHETYPE=0x5b

--Inmato Targets
function s.archetypefilter(c)
  return c:IsCode(83011277, 97534104, 511000100, 100000548, 19113101, 511000106, 511000105, 511000103)
end
...
function s.op(e,tp,eg,ep,ev,re,r,rp)
	if e:GetLabel()==0 then
        ...
        --Plant Monsters in Deck also become DARK.
        ...
        --Plant Monsters on Field & In GY become EARTH.
