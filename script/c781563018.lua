...
function s.flipopactive(e, tp, eg, ep, ev, re, r, rp)
    ...
    randomfriends:AddCard(friend_xyz_to_summon[tp]:TakeatPos(num1))
    randomfriends:AddCard(friend_xyz_to_summon[tp]:TakeatPos(num2))
    randomfriends:AddCard(friend_xyz_to_summon[tp]:TakeatPos(num3))
