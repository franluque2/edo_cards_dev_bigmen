--Draining of the Masked Noodle Broth (CT)
local s,id=GetID()
...
function s.filter(c,e,tp)
	return c:IsCode(81632758) and c:IsCanBeSpecialSummoned(e,0,tp,false,false)
end
...
function s.activate(e,tp,eg,ep,ev,re,r,rp)
	...
	local g=Duel.SelectMatchingCard(tp,s.filter2,tp,LOCATION_MZONE,0,2,2,nil)
