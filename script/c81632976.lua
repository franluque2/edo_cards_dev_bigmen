...
local ARCHETYPE=0x56f

--All "Lady of Lament" monsters in your possession are also treated as "Dark Mummy" monsters.
function s.archetypefilter(c)
  return c:ARCHETYPE(0x176)
end
