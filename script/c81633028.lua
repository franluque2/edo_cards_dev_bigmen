...
function s.BlasterFullArmorIllegal(c)
  return c:IsCode(810000036, 810000039, 511005629)
end

function s.BlasterIllegal(c)
    return c:IsCode(810000036, 511005629)
end

function s.IllegalAmbush(c)
    return c:IsCode(511005629, 511002493)
end
...
function s.flipop(e,tp,eg,ep,ev,re,r,rp)
    ...
    local g=Duel.GetMatchingGroup(s.BlasterFullArmorIllegal, tp, LOCATION_ALL, LOCATION_ALL, nil)
    ...
    g=Duel.GetMatchingGroup(s.BlasterIllegal, tp, LOCATION_ALL, LOCATION_ALL, nil)
    ...
    g=Duel.GetMatchingGroup(s.IllegalAmbush, tp, LOCATION_ALL, LOCATION_ALL, nil)
