--Conscription of Schrödinger's Cat
...
function s.Straynge(c)
  return c:IsOriginalCode(160301010)
end

function s.Cats(c)
  return c:IsCode(160202027, 160202026, 160202025, 160012017)
end
...
function s.flipop(e,tp,eg,ep,ev,re,r,rp)
    ...
    local g=Duel.GetMatchingGroup(s.Straynge, tp, LOCATION_ALL, LOCATION_ALL, nil)
    ...
    g=Duel.GetMatchingGroup(s.Cats, tp, LOCATION_ALL, LOCATION_ALL, nil)
