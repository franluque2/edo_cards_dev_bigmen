--Jetstream Sam of the Winds of Destruction
...
--You can reveal this card from your Hand; Add 1 "Revengeance of the Desperados" from your Deck to your hand, then discard a card, also you cannot Special Summon "Jetstream Sam of the Winds of Destruction" for the rest of this turn.
    ...
    --During the Main Phase: You can Special Summon this card from your Hand, then if you control no other monsters, you can negate the effects of 1 monster on the field, and if you do, destroy 1 monster on the field (if your opponent activated 15 or more cards or effects this turn, this effect and its activation cannot be negated).
...
function s.sptg(e,tp,eg,ep,ev,re,r,rp,chk)
    ...
    if Duel.GetCustomActivityCount(id,1-e:GetHandlerPlayer(),ACTIVITY_CHAIN)>14 then
...
function s.spop(e,tp,eg,ep,ev,re,r,rp)
    ...
    if Duel.SpecialSummon(c,0,tp,tp,false,false,POS_FACEUP)~=0 and c:IsFaceup() and Duel.GetFieldGroupCount(tp, LOCATION_MZONE,0)==1 and Duel.SelectYesNo(tp, aux.Stringid(id, 2)) then
            ...
            if tc then
                ...
                if tc then
                    ...
                    local g2=Duel.SelectMatchingCard(tp,Card.IsDestructable,tp,LOCATION_MZONE,LOCATION_MZONE,1,1,nil)
                    if #g2>0 then
