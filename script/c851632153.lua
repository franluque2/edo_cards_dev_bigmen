...
function s.initial_effect(c)
	...
	chk1:SetCode(946)
	chk1:SetCondition(s.cusxyzCondition(s.mfilter,4,2,99))
	chk1:SetTarget(s.cusxyzTarget(s.mfilter,4,2,99))
	chk1:SetOperation(s.cusxyzOperation(s.mfilter,4,2,99))
	...
	e1:SetCondition(s.cusxyzCondition(s.mfilter,4,2,99))
	e1:SetTarget(s.cusxyzTarget(s.mfilter,4,2,99))
	e1:SetOperation(s.cusxyzOperation(s.mfilter,4,2,99))
