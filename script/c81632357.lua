...
function s.destg(e,tp,eg,ep,ev,re,r,rp,chk)
	local g=Duel.GetMatchingGroup(aux.FaceupFilter(Card.IsLevelBelow,4 or Card.IsRankBelow,4 or Card.IsLinkBelow,2),tp,0,LOCATION_MZONE,nil)
