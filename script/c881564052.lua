...
function s.confunc(e,tp,eg,ep,ev,re,r,rp)
    return Duel.GetCustomActivityCount(id-2,tp,ACTIVITY_CHAIN)<(1+WbAux.GetFatedChantUses(tp)) and e:IsHasType(EFFECT_TYPE_ACTIVATE)
end
...
function s.activate(e,tp,eg,ep,ev,re,r,rp)
    ...
    --Add a copy of every unique Spell card in your opponent's possession to your deck, then choose one to add to your hand
