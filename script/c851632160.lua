...
s.listed_names={01784686,CARD_DARK_MAGICIAN,80019195} --Eye of Timaeus, Dark Magician, Legendary Knight Timaeus
s.listed_series={SET_CELTIC_GUARD}


function s.thfilter(c)
	return ((c:IsSetCard(SET_CELTIC_GUARD) and not c:IsCode(id)) or c:IsCode(01784686)) and c:IsAbleToHand()
end
...
function s.thtg2(e,tp,eg,ep,ev,re,r,rp,chk)
	...
	local b3=fustg(e,tp,eg,ep,ev,re,r,rp,0)
...
function s.filter2(c,e,tp)
	return c:IsCode(80019195) and c:IsCanBeSpecialSummoned(e,0,tp,true,false)
end
