...
function s.condition(e,tp,eg,ep,ev,re,r,rp)
	return Duel.IsExistingMatchingCard(aux.FaceupFilter(Card.IsLevelAbove,8 or Card.IsRankAbove,8 or Card.IsLinkAbove,4),tp,0,LOCATION_MZONE,1,nil)
end
