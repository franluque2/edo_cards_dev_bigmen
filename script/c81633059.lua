...
function s.op(e,tp,eg,ep,ev,re,r,rp)
	if e:GetLabel()==0 then
        ...
        e5:SetTargetRange(LOCATION_EXTRA+LOCATION_ONFIELD,0)
        ...
        e8:SetTarget(function(_,c)  return c:IsSetCard(0x19) and c:IsSpell() and c:IsType(TYPE_EQUIP) end)
...
function s.changecon2(e)
    return Duel.IsExistingMatchingCard(Card.IsOriginalCode, e:GetHandlerPlayer(), LOCATION_ONFIELD, 0, 1, nil, 66309175)
end
