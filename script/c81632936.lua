...
function s.core_filter(c)
	return c:IsCode(100000055)
end

function s.core_filter_field(c)
	return c:IsCode(100000055) and c:IsFaceup() and c:IsDestructable()
end

function s.core_filter_summon(c,e,tp)
	return c:IsCode(100000055) and c:IsCanBeSpecialSummoned(e,0,tp,false,false,POS_FACEUP)
end
