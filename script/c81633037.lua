...
function s.op(e,tp,eg,ep,ev,re,r,rp)
	if e:GetLabel()==0 then
        ...
        e7:SetTarget(aux.TargetBoolFunction(Card.IsCode,511002712,511002721))
        ...
        e8:SetTarget(function (_,c) return (c:IsType(TYPE_SYNCHRO) or c:IsType(TYPE_FUSION)) and not c:IsCode(511002712) end)
