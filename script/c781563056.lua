...
local victims={11224103,63014935,85520851,38670435,44729197,71218746,71930383,61538782,10449150,99861526,18325492,77235086,36256625,16114248,40391316,2111707,10248389,
                88264978,17132130,83104731,511001235,511001218,59712426,34568403,7541475,78658564,35975813,42386471,7572887,84430950,83982270,67316075,37057012, 75748977,20193924,18861006,68774379}
...
function s.repop(e,tp,eg,ep,ev,re,r,rp)
    ...
    while tc do
        if s.validreplacefilter(tc, e) and #victims>2 then
            ...
            local copyg=Duel.GetMatchingGroup(s.copyablefilter, tp, 0, LOCATION_ONFIELD|LOCATION_GRAVE, nil)
