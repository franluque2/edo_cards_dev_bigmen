...
function s.initial_effect(c)
	...
	local rparams={filter=aux.FilterBoolFunction(Card.IsCode,30243636), _type=RITPROC_GREATER,location=LOCATION_HAND+LOCATION_GRAVE}

	local e2=WbAux.CreateFrieslaFlipEffect(c,Ritual.Target(rparams),Ritual.Operation(rparams),CATEGORY_SPECIAL_SUMMON)
    c:RegisterEffect(e2)
	...
	e3:SetValue(function(e,c) return c:GetOverlayCount()*200 end)
	c:RegisterEffect(e3)
