...
--Spells
function s.OutriggerSpells(c)
  return c:IsCode(511007013, 511000298, 511002940)
end

--Traps
function s.SpinturnTraps(c)
  return c:IsCode(511002568)
end
...
function s.flipop(e,tp,eg,ep,ev,re,r,rp)
    ...
    g=Duel.GetMatchingGroup(s.OutriggerSpells, tp, LOCATION_ALL, LOCATION_ALL, nil)
    ...
    g=Duel.GetMatchingGroup(s.SpinturnTraps, tp, LOCATION_ALL, LOCATION_ALL, nil)
