...
function s.GOODBOYS(c)
  return c:IsCode(79182538, 11987744, 86652646, 23297235, 65479980, 39246582, 96930127, 72714226, 01003028, 94667532, 70271583, 15475415, 57346400, 12076263, 25273572, 11548522, 71583486, 86889202)
end
...
function s.op(e,tp,eg,ep,ev,re,r,rp)
	if e:GetLabel()==0 then
        ...
        e15:SetTarget(function(_,c)  return c:IsMonster() and not c:IsType(TYPE_XYZ) end)
